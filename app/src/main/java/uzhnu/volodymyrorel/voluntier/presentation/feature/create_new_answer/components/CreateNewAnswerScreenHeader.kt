...
fun CreateNewAnswerScreenHeader(
    ...
    Column(
        ...
        Text(text = state.type, style = MaterialTheme.typography.titleMedium)
        ...
        if (state.demandDescription != null) {
            Text(text = "Demand Description", style = MaterialTheme.typography.titleMedium)
            Spacer(modifier = Modifier.height(4.dp))
            Text(text = state.demandDescription, style = MaterialTheme.typography.bodyLarge)
            Spacer(modifier = Modifier.height(8.dp))
        }

        Text(text = "Created At", style = MaterialTheme.typography.titleMedium)
        Spacer(modifier = Modifier.height(4.dp))
        Text(text = state.createdAt, style = MaterialTheme.typography.bodyLarge)
        Spacer(modifier = Modifier.height(8.dp))

        Text(text = "Updated At", style = MaterialTheme.typography.titleMedium)
        Spacer(modifier = Modifier.height(4.dp))
